...
var (
	ErrRefreshInvalidString = errors.New("auth-service: invalid refresh string")
	ErrRefreshInvalid       = errors.New("auth-service: invalid refresh token")
	ErrRefreshSession       = errors.New("auth-service: there is no session related to this token")
	ErrRefreshRevoked       = errors.New("auth-service: this token has been already revoke")
	ErrRefreshExpired       = errors.New("auth-service: this token has already expired")
	ErrEmailInvalid         = errors.New("auth-service: invalid mail")
	ErrInvalidCreadentials  = errors.New("auth-service: invalid creadentials")
	ErrMethodNotAllowed     = errors.New("auth-service: this method of sign in is no available for this user")
	ErrHashRequired         = errors.New("auth-service: hash is required")
	ErrUserRequired         = errors.New("auth-service: user is required")
	ErrUserAlreadyExists    = errors.New("auth-service: user is already created")
	ErrCreatedAtRequired    = errors.New("auth-service: createdAt date required")
	ErrExpiredAtRequired    = errors.New("auth-service: expiredAt date required")

	ErrInvalidOTP     = errors.New("auth-service: invalid OTP")
	ErrEmptyOTP       = errors.New("auth-service: empty otp Challenge")
	ErrOTP            = errors.New("auth-service: some error happened while searching for the OTP challenge.")
	ErrOTPNotFound    = errors.New("auth-service: otp challenge was not found")
	ErrOTPExpired     = errors.New("auth-service: otp Challenge is expired")
	ErrOTPInvalidCode = errors.New("auth-service: invalid otp Challenge code")

	ErrPasswordRequired = errors.New("auth-service: password is required")
	ErrRole             = errors.New("auth-service: invalid role type")
	ErrAuthMethod       = errors.New("auth-service: invalid authmethod")
	ErrAuthMethodLen    = errors.New("auth-service: invalid amount of authmethods")
)
