...
var (
	ErrValidation              = errors.New("event-service: string validation error")
	ErrStatus                  = errors.New("event-service: invalid event status type")
	ErrEventType               = errors.New("event-service: invalid event type")
	ErrSeatType                = errors.New("event-service: invalid seat type")
	ErrVisibility              = errors.New("event-service: invalid visibility type")
	ErrAvailability            = errors.New("event-service: invalid availability type")
	ErrSalesDateWithStartEvent = errors.New("event-service: sale date must be at least one hour before the event start date.")
	ErrProvidedID              = errors.New("event-service: provided id is not a valid objectID")
	ErrCurrency                = errors.New("event-service: invalid currency type")
	ErrSortBy                  = errors.New("event-service: invalid sorted type")
	ErrSortDir                 = errors.New("event-service: invalid sortdir type")
	ErrInvalidDateRange        = errors.New("event-service: invalid date range")
)
